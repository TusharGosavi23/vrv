    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Manage roles and their permissions effectively
          </p>
        </div>
        <button
          onClick={handleAddNew}
          className="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-transform transform duration-200 hover:scale-105 shadow-md"
        >
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="p-2 text-blue-600 hover:bg-blue-100 rounded-full transition-transform transform hover:scale-110"
                    title="Edit role"
                  >
                    <FiEdit2 />
                  </button>
                  <button
                    ...
                    className="p-2 text-red-600 hover:bg-red-100 rounded-full transition-transform transform hover:scale-110"
                    title="Delete role"
                  >
                    <FiTrash2 />
                  </button>
      ...
      {roles.length === 0 && (
        <div className="text-center py-12">
          ...
          <button
            onClick={handleAddNew}
            className="mt-4 inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg"
          >
            <FiUserPlus className="mr-2" />
            Add New Role
          </button>
